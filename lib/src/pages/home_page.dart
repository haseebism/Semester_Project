...
import 'package:flutter_medicalibre_app/src/model/dactor_model.dart';
import 'package:flutter_medicalibre_app/src/model/data.dart';
  ...
  Widget _header() {
    return Column(
      ...
      children: <Widget>[
        ...
        Text("Dear", style: TextStyles.h1Style),
      ],
    ).p16;
  }
      ...
      children: <Widget>[
        ...
        SizedBox(
          ...
          child: ListView(
            ...
            children: <Widget>[
              _categoryCard("Chemist & Drugist", "100 + Stores",
                  color: LightColor.purple, lightColor: LightColor.purpleLight),
              _categoryCard("Covid - 19 Specialist", "10 Doctors",
                  color: LightColor.orange, lightColor: LightColor.lightOrange),
              _categoryCard("Cardiologists Specialist", "50 + Doctors",
                  color: LightColor.green, lightColor: LightColor.lightGreen),
              _categoryCard("Dermatologist", "20 + Doctors",
                  color: LightColor.grey, lightColor: LightColor.grey),
              _categoryCard("General Surgeon", "90 + Doctors",
